...
public class AviationUserView extends JPanel implements ActionListener, ItemListener {
	...
	JTextField tfSearch;
	JButton btSearch, btReservation;
	...
	public AviationUserView(Member_DTO dto_userInfo) {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (table.getSelectedColumn() != -1) {
					iPlaneNo = ((int) table.getValueAt(table.getSelectedRow(), 0));
					strPlaneCode = ((String) table.getValueAt(table.getSelectedRow(), 1));
					strPlaneName = ((String) table.getValueAt(table.getSelectedRow(), 2));
					strStartTime = ((String) table.getValueAt(table.getSelectedRow(), 3));
					strArrivalTime = ((String) table.getValueAt(table.getSelectedRow(), 4));
					strStartLoc = ((String) table.getValueAt(table.getSelectedRow(), 5));
					strArrivalLoc = ((String) table.getValueAt(table.getSelectedRow(), 6));
				}
				seat();
	...
	public void reservation() {// 예매
		try {
			...
			strStartDate = String.valueOf(ccb.getDate());
